...
const ALL_TRANSLATIONS = {
  en: {
    ...
    download: {
      ...
      subtitle: 'Get Sherit on your device. iPhone, iPad, and Mac open the App Store; Android downloads directly; Windows downloads a ZIP package.',
      appStore: 'App Store',
      onAppStore: 'On the App Store',
      directDownload: 'Direct download',
      windowsDownload: 'ZIP download (extract and run Sherit.exe)',
      iphone: 'iPhone',
      ipad: 'iPad',
      mac: 'Mac',
      android: 'Android (APK)',
  ...
  zh_hans: {
    ...
    download: {
      title: '下载 Sherit',
      subtitle: '在你的设备上获取 Sherit。iPhone、iPad、Mac 将跳转 App Store，Android 可直接下载，Windows 下载 ZIP 安装包。',
      appStore: 'App Store',
      onAppStore: '前往 App Store',
      directDownload: '直接下载',
      windowsDownload: '下载 ZIP（解压后运行 Sherit.exe）',
      iphone: 'iPhone',
      ipad: 'iPad',
      mac: 'Mac',
      android: 'Android（APK）',

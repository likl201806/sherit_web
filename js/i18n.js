...
const STORAGE_KEY = 'shareme_language';

const ALL_TRANSLATIONS = {
  en: {
    meta: {
      lang: 'en',
      title: 'ShareMe - Local Wi-Fi Chat and File Transfer',
      description: 'ShareMe is a cross-platform local Wi-Fi chat and file transfer app for iPhone, Android, Mac, and Windows. No account, no cloud upload, no cable.'
    },
    nav: {
      home: 'Home',
    ...
    hero: {
      ...
      subtitle: 'ShareMe helps iPhone, Android, Mac, and Windows devices discover each other on the same Wi-Fi, then share messages, photos, videos, folders, clipboard content, and files without accounts or cloud uploads.',
    ...
    features: {
      ...
      reconnectDesc: 'Local chat history keeps recent conversations ready when both devices keep ShareMe open in the foreground.',
      ...
      privacyDesc: 'Transfers happen through your local Wi-Fi network instead of being uploaded to ShareMe cloud servers.'
    },
    download: {
      title: 'Download ShareMe',
      subtitle: 'Get ShareMe on your device. iPhone, iPad, and Mac open the App Store; Android and Windows download directly.',
      appStore: 'App Store',
      onAppStore: 'On the App Store',
      directDownload: 'Direct download',
      windowsDownload: 'Download installer',
      iphone: 'iPhone',
      ipad: 'iPad',
      mac: 'Mac',
      android: 'Android (APK)',
    ...
    footer: {
      ...
      support: 'Support',
      contact: 'Contact us',
      copyright: '© 2026 ShareMe. All rights reserved.'
    },
    support: {
      metaTitle: 'Support - ShareMe',
      metaDescription: 'ShareMe support, FAQs, troubleshooting, and contact information.',
      title: 'Support',
      ...
      q1: 'Which devices does ShareMe support?',
      a1: 'ShareMe is designed for iPhone, Android, Mac, and Windows devices on the same Wi-Fi network.',
      ...
      a3: 'No. ShareMe does not require account registration before nearby chat or file transfer.',
      q4: 'Are files uploaded to the cloud?',
      a4: 'No. ShareMe is designed around local network transfer. Files are sent between nearby devices over the local Wi-Fi network.',
      q5: 'Why can’t I find another device?',
      a5: 'Make sure both devices are on the same Wi-Fi, ShareMe is open in the foreground, local network permission is allowed, and firewall or VPN settings are not blocking discovery.',
      q6: 'Can I transfer folders?',
      a6: 'Yes. ShareMe supports sending entire folders along with photos, videos, audio, documents, and other files.',
    ...
    privacy: {
      metaTitle: 'Privacy Policy - ShareMe',
      metaDescription: 'ShareMe privacy policy for local Wi-Fi chat and file transfer.',
      title: 'Privacy Policy',
      updated: 'Last updated: July 2, 2026',
      introTitle: 'Overview',
      introP1: 'ShareMe is built for local Wi-Fi chat and file transfer. This policy explains what information may be used when you use ShareMe and how local sharing is designed to work.',
      introP2: 'By using ShareMe, you agree to this privacy policy. If you do not agree, please stop using the app.',
      localTitle: 'Local-first transfers',
      localP: 'ShareMe is designed to transfer files between nearby devices on the same local Wi-Fi network. Files are not uploaded to ShareMe cloud servers for normal chat and transfer.',
      noAccountTitle: 'No account registration',
      noAccountP: 'ShareMe does not require you to create an account. You can discover nearby devices and start sharing without registering a cloud identity with us.',
      ...
      receivingP: 'When you send or receive content, ShareMe processes that content only as needed to complete the local transfer and save it on the receiving device.',
      ...
      permissionsP: 'ShareMe may request permissions such as local network, photos, files, notifications, or clipboard access depending on the feature you use. You can manage these permissions in your system settings.',
      ...
      updatesP: 'We may update this policy as ShareMe evolves. The updated policy will show a new last updated date.',
      contactTitle: 'Contact us',
      contactP: 'If you have questions about this privacy policy, contact us at 759447915@qq.com.'
    },
    terms: {
      metaTitle: 'Terms of Service - ShareMe',
      metaDescription: 'ShareMe terms of service for local Wi-Fi chat and file transfer.',
      title: 'Terms of Service',
      updated: 'Last updated: July 2, 2026',
      serviceTitle: 'Service description',
      serviceP1: 'ShareMe provides local Wi-Fi device discovery, chat, and file transfer features for nearby devices.',
      serviceP2: 'By using ShareMe, you agree to use the app responsibly and in compliance with applicable laws.',
      useTitle: 'Acceptable use',
      useP: 'You may not use ShareMe to send illegal, harmful, infringing, abusive, or unauthorized content. Do not attempt to disrupt, reverse engineer, or misuse the app or another user’s device.',
      contentTitle: 'Your content',
      contentP: 'You are responsible for the messages, files, folders, clipboard content, and media you choose to send or receive through ShareMe. Only share content that you have the right to share.',
      networkTitle: 'Local network and device requirements',
      networkP: 'ShareMe depends on local network availability, system permissions, device state, firewall settings, and platform behavior. Discovery or transfer may fail when these conditions block communication.',
      privacyTitle: 'Privacy and permissions',
      privacyP: 'ShareMe may request permissions required for discovery, transfer, media import, notifications, and related features. Please review the privacy policy for more detail.',
      availabilityTitle: 'Availability',
      availabilityP: 'ShareMe is provided as available. Features may change, be interrupted, or work differently across platforms and operating system versions.',
      ...
      updatesP: 'We may update these terms from time to time. Continuing to use ShareMe after updates means you accept the revised terms.',
      contactTitle: 'Contact us',
  ...
  zh_hans: {
    meta: {
      lang: 'zh-Hans',
      title: 'ShareMe - 局域网聊天与文件传输',
      description: 'ShareMe 是一款跨平台局域网聊天与文件传输工具，支持 iPhone、Android、Mac、Windows。同一 Wi-Fi 下即可快速分享，无需账号、无需云端上传、无需数据线。'
    },
    nav: {
      home: '首页',
      screenshots: '截图',
    ...
    hero: {
      ...
      subtitle: 'ShareMe 可让 iPhone、Android、Mac、Windows 设备在同一 Wi-Fi 下互相发现，并快速发送文本、图片、视频、文件夹、剪贴板内容和各类文件，无需注册账号，也无需上传云端。',
      download: '查看下载',
      learnMore: '技术支持',
      noAccount: '无需账号',
      noCloud: '无需云端上传',
    ...
    features: {
      ...
      privacyTitle: '局域网内传输',
      privacyDesc: '文件通过本地 Wi-Fi 网络在设备之间传输，不上传到 ShareMe 云端服务器。'
    },
    download: {
      title: '下载 ShareMe',
      subtitle: '在你的设备上获取 ShareMe。iPhone、iPad、Mac 将跳转 App Store，Android 和 Windows 可直接下载。',
      appStore: 'App Store',
      onAppStore: '前往 App Store',
      directDownload: '直接下载',
      windowsDownload: '下载安装程序',
      iphone: 'iPhone',
      ipad: 'iPad',
      mac: 'Mac',
      android: 'Android（APK）',
    ...
    footer: {
      ...
      support: '支持',
      contact: '联系我们',
      copyright: '© 2026 ShareMe. 保留所有权利。'
    },
    support: {
      metaTitle: '技术支持 - ShareMe',
      metaDescription: 'ShareMe 技术支持、常见问题、故障排查与联系方式。',
      title: '技术支持',
      ...
      faqTitle: '常见问题',
      q1: 'ShareMe 支持哪些设备？',
      a1: 'ShareMe 面向同一 Wi-Fi 下的 iPhone、Android、Mac、Windows 设备。',
      q2: '设备必须连接同一个 Wi-Fi 吗？',
      a2: '是的。附近设备发现和局域网传输需要双方连接到同一个本地网络。',
      q3: '需要注册账号吗？',
      a3: '不需要。ShareMe 无需注册账号即可发现附近设备并开始聊天或传输文件。',
      q4: '文件会上传到云端吗？',
      a4: '不会。ShareMe 以局域网传输为核心，文件通过本地 Wi-Fi 在附近设备之间发送。',
      q5: '为什么找不到另一台设备？',
      a5: '请确认双方连接同一 Wi-Fi、ShareMe 保持前台运行、已允许本地网络权限，并检查防火墙或 VPN 是否阻止设备发现。',
      q6: '可以传输文件夹吗？',
      a6: '可以。ShareMe 支持发送整个文件夹，也支持照片、视频、音频、文档和其他文件。',
      q7: '收到的文件保存在哪里？',
    ...
    privacy: {
      metaTitle: '隐私协议 - ShareMe',
      metaDescription: 'ShareMe 局域网聊天与文件传输隐私协议。',
      title: '隐私协议',
      updated: '最后更新日期：2026年7月2日',
      introTitle: '概述',
      introP1: 'ShareMe 是一款面向局域网 Wi-Fi 聊天与文件传输的应用。本协议说明你在使用 ShareMe 时可能涉及的信息，以及局域网共享的工作方式。',
      introP2: '使用 ShareMe 即表示你同意本隐私协议。如果你不同意，请停止使用本应用。',
      localTitle: '本地优先的传输方式',
      localP: 'ShareMe 设计用于在同一局域网 Wi-Fi 下的附近设备之间传输文件。正常聊天和传输过程中，文件不会上传到 ShareMe 云端服务器。',
      noAccountTitle: '无需账号注册',
      noAccountP: 'ShareMe 不要求你创建账号。你可以无需向我们注册云端身份，即可发现附近设备并开始分享。',
      ...
      receivingP: '当你发送或接收内容时，ShareMe 仅为完成局域网传输和保存到接收设备而处理这些内容。',
      diagnosticsTitle: '反馈与诊断信息',
      diagnosticsP: '如果你主动发送反馈，可能会提供截图、日志、设备信息或问题描述。我们仅将这些信息用于理解和解决你的请求。',
      permissionsTitle: '设备权限',
      permissionsP: '根据你使用的功能，ShareMe 可能请求本地网络、照片、文件、通知或剪贴板等权限。你可以在系统设置中管理这些权限。',
      securityTitle: '安全',
      securityP: '局域网传输可以减少不必要的互联网暴露，但你仍应只与可信任的设备和人员共享内容。',
      updatesTitle: '协议更新',
      updatesP: '随着 ShareMe 功能变化，我们可能更新本协议。更新后的协议会显示新的最后更新日期。',
      contactTitle: '联系我们',
      contactP: '如果你对本隐私协议有任何疑问，请通过 759447915@qq.com 联系我们。'
    },
    terms: {
      metaTitle: '用户政策 - ShareMe',
      metaDescription: 'ShareMe 局域网聊天与文件传输用户政策。',
      title: '用户政策',
      updated: '最后更新日期：2026年7月2日',
      serviceTitle: '服务说明',
      serviceP1: 'ShareMe 为附近设备提供局域网 Wi-Fi 设备发现、聊天和文件传输功能。',
      serviceP2: '使用 ShareMe 即表示你同意以负责任的方式使用本应用，并遵守适用法律法规。',
      useTitle: '使用规范',
      useP: '你不得使用 ShareMe 发送违法、有害、侵权、骚扰或未经授权的内容，也不得干扰、逆向工程、滥用本应用或他人设备。',
      contentTitle: '你的内容',
      contentP: '你应对通过 ShareMe 发送或接收的消息、文件、文件夹、剪贴板内容和媒体负责。请仅分享你有权分享的内容。',
      networkTitle: '本地网络与设备要求',
      networkP: 'ShareMe 依赖本地网络可用性、系统权限、设备状态、防火墙设置和平台行为。当这些条件阻止通信时，设备发现或文件传输可能失败。',
      privacyTitle: '隐私与权限',
      privacyP: 'ShareMe 可能请求设备发现、传输、媒体导入、通知等功能所需权限。更多说明请查看隐私协议。',
      availabilityTitle: '服务可用性',
      availabilityP: 'ShareMe 按现状提供。功能可能发生变化、中断，或在不同平台和系统版本上表现不同。',
      liabilityTitle: '责任限制',
      liabilityP: '在法律允许范围内，我们不对间接损失、因用户操作、网络故障、设备设置或不受支持的使用方式造成的数据损失承担责任。',
      updatesTitle: '政策变更',
      updatesP: '我们可能不时更新本政策。更新后继续使用 ShareMe，即表示你接受修订后的政策。',
      contactTitle: '联系我们',
